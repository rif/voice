...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="article.titlepage.recto.style" text-align="center" margin-left="{$title.margin.left}" keep-with-next="always" font-size="24.8832pt" font-weight="bold" font-family="{$title.font.family}">
