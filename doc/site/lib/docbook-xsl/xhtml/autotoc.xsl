...
<xsl:template match="part|reference" mode="toc">
  <xsl:variable name="nodes" select="appendix|chapter|article                                      |index|glossary|bibliography                                      |preface|reference|refentry                                      |bridgehead"/>
...
<xsl:template match="preface|chapter|appendix|article" mode="toc">
  ...
  <xsl:element name="{$toc.listitem.type}">
    ...
    <xsl:if test="$toc.listitem.type = 'li'                   and $toc.section.depth&gt;0 and section|sect1">
      <xsl:copy-of select="$subtoc.list"/>
    </xsl:if>
  </xsl:element>
  <xsl:if test="$toc.listitem.type != 'li'                 and $toc.section.depth&gt;0 and section|sect1">
...
<xsl:template match="sect1" mode="toc">
  ...
  <xsl:element name="{$toc.listitem.type}">
    ...
    <xsl:if test="$toc.listitem.type = 'li'                   and $toc.section.depth&gt;1 and sect2">
      <xsl:copy-of select="$subtoc.list"/>
    </xsl:if>
  </xsl:element>
  <xsl:if test="$toc.listitem.type != 'li'                 and $toc.section.depth&gt;1 and sect2">
...
<xsl:template match="sect2" mode="toc">
  ...
  <xsl:element name="{$toc.listitem.type}">
    ...
    <xsl:if test="$toc.listitem.type = 'li'                   and $toc.section.depth&gt;2 and sect3">
      <xsl:copy-of select="$subtoc.list"/>
    </xsl:if>
  </xsl:element>
  <xsl:if test="$toc.listitem.type != 'li'                 and $toc.section.depth&gt;2 and sect3">
...
<xsl:template match="sect3" mode="toc">
  ...
  <xsl:element name="{$toc.listitem.type}">
    ...
    <xsl:if test="$toc.listitem.type = 'li'                   and $toc.section.depth&gt;3 and sect4">
      <xsl:copy-of select="$subtoc.list"/>
    </xsl:if>
  </xsl:element>
  <xsl:if test="$toc.listitem.type != 'li'                 and $toc.section.depth&gt;3 and sect4">
...
<xsl:template match="sect4" mode="toc">
  ...
  <xsl:element name="{$toc.listitem.type}">
    ...
    <xsl:if test="$toc.listitem.type = 'li'                   and $toc.section.depth&gt;4 and sect5">
      <xsl:copy-of select="$subtoc.list"/>
    </xsl:if>
  </xsl:element>
  <xsl:if test="$toc.listitem.type != 'li'                 and $toc.section.depth&gt;4 and sect5">
...
<xsl:template match="section" mode="toc">
  ...
  <xsl:element name="{$toc.listitem.type}">
    ...
    <xsl:if test="$toc.listitem.type = 'li'                   and $toodeep='no' and section">
      <xsl:copy-of select="$subtoc.list"/>
    </xsl:if>
  </xsl:element>
  <xsl:if test="$toc.listitem.type != 'li'                 and $toodeep='no' and section">
